...
5. 配置部署基于 OTRS/Znuny 和电子邮件的工单系统。桌面与打印机支持；

6. 配置维护交换机、FG 防火墙（联系厂商技术支持，降级至 7.2.8 成熟版本）；

7. 对各研发部门的 GitLab/SVN 等重要数据进行切实可靠的备份；

8. 建立 KMS 服务器，对办公网、研发内网的 Windows/Office 软件进行激活；

9. 建立主/备的 Windows AD 服务器，对各种应用/系统实行统一账号认证；

10. 建立对外（外包团队）的 SFTP 服务器，以及从办公网到研发内网的单向上传通道；

11. 对于上海机房 UPS 失效，提出并迭代了新的 UPS 方案；

12. 编译安装 GCC/GDB 等工具，解决硬件/软件研发部门对这些编译器、调试工具的使用需求。
