...
8. 上架及配置一台 DELL/EMC ME5012+ME412 的存储设备，采用多路径，用于数据备份与研发生产用途；

9. 对各研发部门的 GitLab/SVN 等重要数据进行切实可靠的备份；

10. 建立 KMS 服务器，对办公网、研发内网的 Windows/Office 软件进行激活；

11. 建立主/备的 Windows AD 服务器，对各种应用/系统实行统一账号认证；

12. 建立对外（外包团队）的 SFTP 服务器，以及从办公网到研发内网的单向上传通道；


13. 对于上海机房 UPS 失效，提出并迭代了新的 UPS 方案；

14. 编译安装 GCC/GDB 等工具，解决硬件/软件研发部门对这些编译器、调试工具的使用需求。
